...
The networking layer for `@game` - a TypeScript game engine. Implements server-authoritative architecture with client-side prediction, server reconciliation, entity interpolation, and lag compensation.
...
See the [docs](../../docs/) folder in the repository root:
